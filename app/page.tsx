              ...
              <div data-animate className="opacity-0 translate-y-10 transition-all duration-1000" style={{ transitionDelay: "300ms" }}>
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    ...
                    className="group inline-flex items-center justify-center gap-3 px-9 py-4 min-w-[220px] whitespace-nowrap bg-gradient-to-r from-[#4285F4] to-[#1a73e8] text-white font-semibold rounded-xl text-lg hover:shadow-xl hover:shadow-blue-500/40 transition-all duration-300 hover:scale-105"
                  >
                  ...
                  <a
                    href="/download/edge"
                    className="group inline-flex items-center justify-center gap-3 px-9 py-4 min-w-[220px] whitespace-nowrap bg-gradient-to-r from-[#0078D4] to-[#1CA3EC] text-white font-semibold rounded-xl text-lg hover:shadow-xl hover:shadow-cyan-500/40 transition-all duration-300 hover:scale-105"
                  >
                    <svg className="w-6 h-6" viewBox="0 0 48 48">
                      <circle cx="24" cy="24" r="20" fill="#fff" fillOpacity="0.15"/>
                  ...
                  <a
                    ...
                    className="group inline-flex items-center justify-center gap-3 px-9 py-4 min-w-[220px] whitespace-nowrap bg-gradient-to-r from-green-500 to-emerald-500 text-white font-semibold rounded-xl text-lg hover:shadow-xl hover:shadow-green-500/40 transition-all duration-300 hover:scale-105"
                  >
                ...
                <p className="text-sm text-muted-foreground mt-4">Works with Chrome, Edge, Brave & more</p>
              </div>
            </div>
