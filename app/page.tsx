              ...
              <div data-animate className="opacity-0 translate-y-10 transition-all duration-1000" style={{ transitionDelay: "300ms" }}>
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <a
                    ...
                    className="group inline-flex items-center justify-center gap-3 px-10 py-4 min-w-[260px] whitespace-nowrap bg-gradient-to-r from-green-500 to-emerald-500 text-white font-semibold rounded-xl text-lg hover:shadow-xl hover:shadow-green-500/40 transition-all duration-300 hover:scale-105"
                  >
