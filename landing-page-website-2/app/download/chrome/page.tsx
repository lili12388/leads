...
export default function ChromeDownloadPage() {
  const steps = [
    ...
    },
    {
      ...
      description: "Open Chrome and type chrome://extensions in the address bar, then press Enter.",
    },
    {
      number: 4,
      title: "Enable Developer Mode",
      description: "Toggle ON the 'Developer mode' switch in the top-right corner of the page.",
    },
    {
      number: 5,
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#020a18] via-[#041225] to-[#020510]">
      ...
      <header className="py-0 px-8 border-b border-border/30">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link href="/download/edge" className="text-muted-foreground hover:text-foreground transition-all duration-300 text-base font-medium px-4 py-2 rounded-lg hover:bg-white/10">Edge Version</Link>
          </div>
        </div>
      </header>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-[#4285F4] to-[#1a73e8] text-white font-bold rounded-2xl text-xl hover:shadow-xl hover:shadow-blue-500/40 transition-all duration-200 hover:scale-105"
          >
      ...
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Video Placeholder */}
          <div className="aspect-video bg-black/30 rounded-2xl mb-10 flex items-center justify-center border border-[#4285F4]/30 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {steps.map((step) => (
              <div key={step.number} className="p-5 rounded-xl bg-card/50 border border-border/50 hover:border-[#4285F4]/50 transition-colors">
          ...
          {/* Also Works With */}
          <div className="mt-12 p-6 bg-card/30 rounded-xl border border-border/50 text-center">
